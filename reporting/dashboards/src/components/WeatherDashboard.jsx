...
const WeatherDashboard = () => {
  ...
  // Demo API key - replace with real one
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-blue-900 to-purple-900 rounded-lg p-6 border border-gray-700">
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="text-4xl font-bold text-white">{Math.round(weatherData.temp)}°C</div>
              <div>
                <p className="text-gray-300">Feels like {Math.round(weatherData.feels_like)}°C</p>
              ...
              {forecast.map((day, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-800 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="text-white">{day.temp_max}°</p>
                    <p className="text-gray-400 text-sm">{day.temp_min}°</p>
                  </div>
                </div>
              ))}
            </div>
